...
def compute_tf_model(mav, trim_state, trim_input):
    ...
    T_phi_delta_a = ss.TransferFunction([a_phi_2],[1,a_phi_1,0])
    print("T_phi_delta_a",T_phi_delta_a)

    # Transfer function phi --> chi
    #dx = np.tan(phi)-phi
    T_chi_phi = ss.TransferFunction([MAV.gravity/mav._Vg],[1,0])
    ...
    T_theta_delta_e = ss.TransferFunction([a_theta_3],[1,a_theta_1,a_theta_2])
    print("T_theta_delta_e",T_theta_delta_e )

    # Transfer function theta --> h
    T_h_theta = ss.TransferFunction([mav._Va],[1,0])
    print("T_h_theta",T_h_theta)

    # Transfer function Va --> h
    T_h_Va = ss.TransferFunction([theta],[1,0])
    print("T_h_Va",T_h_Va)
    ...
    T_Va_delta_t = ss.TransferFunction([a_v_2],[1.0,a_v_1])
    print("T_Va_delta_t",T_Va_delta_t)

    # Transfer funciton theta --> Va
    a_v_3 = MAV.gravity
    T_Va_theta = ss.TransferFunction([-a_v_3],[1.0,a_v_1])
    ...
    T_beta_delta_r = ss.TransferFunction([a_beta_2],[1.0,a_beta_1])
