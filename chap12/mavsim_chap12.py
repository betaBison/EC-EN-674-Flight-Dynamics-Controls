...
world_view = world_viewer(map)  # initialize the viewer
...
# plan path
path_plan = path_planner(map,world_view,[P.pn0_corner,P.pe0_corner,P.pd0])
...
while sim_time < SIM.end_time:
    ...
    if path_manage.flag_need_new_waypoints:
        ...
        path_manage.flag_need_new_waypoints = False
    #-------path manager-------------
